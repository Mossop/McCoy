...
function fileChosen() {
  ...
  if (file && file.exists()) {
    try {
      gManifest = InstallManifestFactory.loadFromFile(file);
      ...
      alert(getString("addkey.invalidrdf"));
    }
  }
...
function save() {
  ...
  if (fp.show() != Ci.nsIFilePicker.returnCancel) {
    gManifest.updateKey = document.getElementById("key").key.exportPublicKey();
